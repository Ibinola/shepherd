    ...
    <div>
      ...
      <div className="bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        <div className="flex justify-between items-center py-4 border-b border-gray-200">
          <div>
            ...
            {state.isEditing.email ? (
              <input
                ...
                className="border border-gray-300 rounded px-2 py-1 text-sm focus:border-[#207df7] focus:outline-0"
              />
            ) : (
          ...
          <button
            className="text-sm text-[#207df7] hover:text-blue-600"
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        ...
        <div className="flex justify-between items-center py-4 border-b border-gray-200">
          ...
          <button className="text-sm text-[#207df7] hover:animate-bounce">
            &#8250;
          </button>
        </div>
