...
function ReviewModal({ showReviewModal, setShowReviewModal }) {
  ...
  return (
    <div className="fixed inset-0 z-30 flex items-center justify-center transition-all duration-300 ease-in-out">
      ...
      <div className="bg-white max-h-full z-30 p-6 rounded-lg shadow-lg relative w-[422px] h-[335px] transition-all duration-300 ease-in-out fade-in-out">
        <button
        ...
        <ReviewContent />
        <div className="flex text-left justify-center items-center border rounded-xl w-[365px] mt-2 max-w-md mx p-4 text-[#212224] font-[400]">
          Anything is possible when you believe in yourself! This is my first
          React project,If it impresses you,give me a thumbs up!! Feel free to
          modify it if you need to add or change anything
        </div>
      </div>
    </div>
  );
