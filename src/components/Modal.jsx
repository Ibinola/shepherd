...
function Modal({ showModal, setShowModal }) {
  ...
  return (
    <div
      className={`fixed inset-0 z-30 flex items-center justify-center fade-in-out transition-all duration-300 ease-in-out
      }`}
    >
      <div
      ...
      {/* Modal content */}
      <div
        className={`bg-white z-30 p-6 rounded-lg shadow-lg relative w-[422px] transition-transform duration-300 ease-in-out transform ${
